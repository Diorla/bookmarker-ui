...
const elevation = {
  low: `${shade.light} 0.15rem 0.15rem 0.3rem, ${shade.lightest} -0.1rem -0.1rem 0.25rem;`,
  medium: `${shade.light} 0.3rem 0.3rem 0.6rem, ${shade.lightest} -0.2rem -0.2rem 0.5rem`,
  high: `${shade.light} 0.6rem 0.6rem 1.2rem, ${shade.lightest} -0.4rem -0.4rem 1rem`,
};
